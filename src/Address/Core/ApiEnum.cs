    ...
    where TEnum : struct, Enum
{
    ...
    ///
    /// <exception cref="AddressInvalidDataException">
    ...
    public TRaw Raw()
    {
        try
        {
            return JsonSerializer.Deserialize<TRaw>(this.Json, ModelBase.SerializerOptions)
                ?? throw new AddressInvalidDataException($"{nameof(this.Json)} cannot be null");
        }
    ...
    public void Validate()
    {
        ...
        {
            throw new AddressInvalidDataException("Invalid enum value");
        }
    }
