...
public abstract record class ParamsBase
{
    ...
    static ParamsBase()
    {
        ...
        var customHeadersEnv = Environment.GetEnvironmentVariable("ADDRESS_CUSTOM_HEADERS");
    ...
    static string GetUserAgent() => $"{typeof(AddressClient).Name}/C# {GetPackageVersion()}";
