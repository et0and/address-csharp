...
/// </summary>
public record class ChallengeRetrieveParams : ParamsBase
{
    public ChallengeRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ChallengeRetrieveParams(ChallengeRetrieveParams challengeRetrieveParams)
        : base(challengeRetrieveParams) { }
...
#pragma warning restore CS8618
    ...
    public static ChallengeRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ChallengeRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/challenge")
        {
