...
/// `lng`: Longitude in decimal degrees (required) - `limit`: Maximum number of results
/// (default: 10, max: 100) - `format`: Response format - "full" or "simple"</para>
///
...
/// </summary>
public record class ReverseGeocodeParams : ParamsBase
{
    public required string Point
    {
        get
        {
            ...
            return this._rawQueryData.GetNotNullClass<string>("point");
        }
        init { this._rawQueryData.Set("point", value); }
    }
    ...
    public ReverseGeocodeParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ReverseGeocodeParams(ReverseGeocodeParams reverseGeocodeParams)
        : base(reverseGeocodeParams) { }
...
#pragma warning restore CS8618
    ...
    public virtual bool Equals(ReverseGeocodeParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/reverse")
        {
